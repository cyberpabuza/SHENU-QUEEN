 ...
 Void.ev.on('group-participants.update', async(anu) => {
        ...
        Void.ev.on('connection.update', async(update) => {
                ...
                if (connection === 'open') {
                    ...
                    for (let i of owner) {
                        Void.sendMessage(i + "@s.whatsapp.net", { text: `╔⚊────❰♦𝗦𝗛𝗘𝗡𝗨-𝗤𝗨𝗘𝗘𝗡♦❱───⚊╗\n┃ _*SHENU-QUEEN MD CONECTED✅*._\n┃ _💕𝗧𝗢𝗧𝗔𝗟 𝗣𝗟𝗨𝗚𝗜𝗡𝗦 : ${events.commands.length}_\n┃ _🎀𝗠𝗢𝗗𝗘: ${Config.WORKTYPE}_\n┃ _🙈𝗩𝗘𝗥𝗦𝗜𝗢𝗡:- 0.0.5_\n┆ _❥𝗕𝗥𝗔𝗡𝗖𝗛:- ${Config.BRANCH}_\n┃ _🎊𝗧𝗛𝗘𝗠𝗘: ${Config.LANG}_\n┃ _🧛𝗢𝗪𝗡𝗘𝗥:- ${process.env.OWNER_NAME}_\n┃♦ _PUBLIC GROUP_ : *https://chat.whatsapp.com/KCb5XO0jhm676fNwkJz93o*\n┃╚─◈──────────◈─╝\n┃♠︎ 𝗡𝗔𝗠𝗘 :CYBER THUSHAN\n┃♠︎ 𝗡𝗨𝗠𝗕𝗘𝗥 : 94710109956\n┃♠︎ 𝗣𝗥𝗘𝗠𝗜𝗨𝗠 : ♦\n╚⚊─────────────⚊╝\n` })
                    }
		    }
